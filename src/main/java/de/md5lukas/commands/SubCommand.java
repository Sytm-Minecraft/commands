...
public abstract class SubCommand {
    ...
    void onCommand(CommandSender sender, LinkedList<String> args) {
        ...
        String subCommandName = args.getFirst().toLowerCase();
    ...
    final List<String> onTabComplete(CommandSender sender, LinkedList<String> args) {
        if (!guard(sender, args, true)) {
            return Collections.emptyList();
        }
        String subCommandName = args.getFirst().toLowerCase();
        for (SubCommand subCommand : subCommands) {
        ...
        List<String> completions = subCommands.stream().map(SubCommand::getName).collect(Collectors.toList());
